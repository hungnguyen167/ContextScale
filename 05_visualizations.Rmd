...
d2v_gen <- read_csv("data/py_outputs/r&c_gen.csv") %>% 
    ...
    mutate(election = as.numeric(election), party = as.numeric(party))
d2v_env <- read_csv("data/py_outputs/r&c_env.csv") %>% 
    separate("party_election", sep="\\_", into = c("party", "election")) %>%
    mutate(election = as.numeric(election), party = as.numeric(party))
d2v_envp <- read_csv("data/py_outputs/r&c_envp.csv") %>% 
    separate("party_election", sep="\\_", into = c("party", "election")) %>%
    mutate(election = as.numeric(election), party = as.numeric(party))
d2v_wf <- read_csv("data/py_outputs/r&c_wf.csv") %>% 
    separate("party_election", sep="\\_", into = c("party", "election")) %>%
    mutate(election = as.numeric(election), party = as.numeric(party))
d2v_td <- read_csv("data/py_outputs/r&c_td.csv") %>% 
    separate("party_election", sep="\\_", into = c("party", "election")) %>%
    mutate(election = as.numeric(election), party = as.numeric(party))
d2v_fm <- read_csv("data/py_outputs/r&c_fm.csv") %>% 
    separate("party_election", sep="\\_", into = c("party", "election")) %>%
    mutate(election = as.numeric(election), party = as.numeric(party))
d2v_mil <- read_csv("data/py_outputs/r&c_mil.csv") %>% 
    separate("party_election", sep="\\_", into = c("party", "election")) %>%
    mutate(election = as.numeric(election), party = as.numeric(party))
...
tf_envp <- read_csv("data/py_outputs/tf_envp.csv")
tf_mil <- read_csv("data/py_outputs/tf_mil.csv")
...
wf_envp <- read.csv("data/r_outputs/wf_envp.csv")
wf_mil <- read.csv("data/r_outputs/wf_mil.csv")
...
figure_2 <- ggarrange(plot_tf1, plot_wf, plot_d2v1,plot_cmplog,
                      common.legend = TRUE)
...
figure_4 <- ggarrange(plot_envp_cs, plot_envp_d2v, plot_envp_wf,plot_envp_log,
                      plot_mil_cs, plot_mil_d2v, plot_mil_wf,plot_mil_log,
                      common.legend = TRUE, ncol=4, nrow=2) 

agg_png(filename = here::here("results","tabs and figs","figure 4.png"), res = 360, width = 4800, height = 2400)
figure_4
invisible(dev.off())
