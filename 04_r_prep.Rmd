...
This script runs **after** `03a_main_analyses.ipynb`. It uses the preprocessed
...
Prerequisites:
- `03a_main_analyses.ipynb` must have been run through at minimum:
  - **Section 3.1** (Data Preparation) — produces `data/py_outputs/manifesto.csv`
  - **Section 3.4** (Twitter fine-tuning) — produces `data/py_outputs/tw_processed.csv`
