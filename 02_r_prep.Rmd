...
manifesto_env = manifesto_deu[which(manifesto_deu$cmp_code %in% c('410','416','501',"416.1","416.2")),]
...
manifesto_econ = manifesto_deu[which(manifesto_deu$cmp_code %in%
...
## Wordfish - Labour and Social Welfare

```{r wf_socwel}

manifesto_socwel = manifesto_deu[which(manifesto_deu$cmp_code %in% c('503','504','505','701','702')),]
...
manifesto_eu = manifesto_deu[which(manifesto_deu$cmp_code %in% c('108','110')),]
...
manifesto_imm = manifesto_deu[which(manifesto_deu$cmp_code %in% c('601','602','607','608','601.1','601.2','602.1','602.2','607.1','607.2','607.3','608.1','608.2','608.3')),]
...
manifesto_ep = manifesto_deu[which(manifesto_deu$cmp_code =='501'),]
...
manifesto_growth = manifesto_deu[which(manifesto_deu$cmp_code %in% c('410','416', "416.1", "416.2")),]
